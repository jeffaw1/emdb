...
def load_HMR2(result_root, force_load=False):
    """Load scoreHMR results."""
    hybrik_cache_dir = os.path.join(result_root, "cache")
    hybrik_cache_file = os.path.join(hybrik_cache_dir, "HMR_out2.npz")
    print('result_root', result_root)
    if not os.path.exists(hybrik_cache_file) or force_load:
        pose_hat, shape_hat, trans_hat = [], [], []
...
def load_nlf1(result_root, force_load=False):
    ...
    #print('result_root:::', result_root)
    hybrik_cache_dir = os.path.join(result_root, "cache")
    hybrik_cache_file = os.path.join(hybrik_cache_dir, "nlf1_out.npz")
    print('result_root', result_root)
    if not os.path.exists(hybrik_cache_file) or force_load:
        pose_hat, shape_hat, trans_hat = [], [], []
...
def load_nlf2(result_root, force_load=False):
    ...
    #print('result_root:::', result_root)
    hybrik_cache_dir = os.path.join(result_root, "cache")
    hybrik_cache_file = os.path.join(hybrik_cache_dir, "nlf2_out.npz")
    print('result_root', result_root)
    if not os.path.exists(hybrik_cache_file) or force_load:
        pose_hat, shape_hat, trans_hat = [], [], []
