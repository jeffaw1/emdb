...
from evaluation_engine import HYBRIK, SCOREHMR, NIKI, TRAM, NLF, NLFs, PLIKS, PartialHuman, EvaluationEngine
...
if __name__ == "__main__":
    ...
    baselines_to_evaluate = [SCOREHMR, NIKI, TRAM, NLF, NLFs, PLIKS, PartialHuman]
